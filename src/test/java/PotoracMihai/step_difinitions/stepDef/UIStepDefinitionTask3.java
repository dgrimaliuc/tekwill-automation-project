package PotoracMihai.step_difinitions.stepDef;

import PotoracMihai.ui.shopify.pages.ShopifyTask3;
...
import static PotoracMihai.ui.shopify.pages.ShopifyTask3.*;
import static org.hamcrest.MatcherAssert.assertThat;
import static org.hamcrest.Matchers.*;
public class UIStepDefinitionTask3 {
    ShopifyTask3 shopifyPage = new ShopifyTask3();
    ...
    public void verifyColorIsGrayAndBrown() {
        ...
        for(WebElement el : els){
            String actual = el.getAttribute("data-t");
            assertThat(actual, anyOf(equalTo("Gray".toLowerCase()), equalTo("Brown".toLowerCase())));
        }
    ...
    public void verifyGenderIsMaleAndFemale() {
        var genders = driver.findElements(cardGenders);
        for(WebElement el : genders){
            String text = el.getText();
            assertThat(text, anyOf(equalTo("Male".toLowerCase()), equalTo("Female".toLowerCase())));
        }
    }
