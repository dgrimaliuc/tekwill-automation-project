...
public class PetstoreInfoTest extends BaseTest {
    ...
    public void defaultInfoTest() {
        ...
        String actualAdoptionsCount = petStore.informationSection.adoptionCount.getText();
    ...
    public void getExactInfoTest() {
        ...
        petStore.petsSection.pets.get(0).click();
               petStore.petsSection.adoptionButton.click();

        actions.shouldHaveTextEndsWith(petStore.informationSection.petsCount, ": " + petsCount);
        actions.shouldHaveTextEndsWith(petStore.informationSection.adoptionCount, ": 1");
