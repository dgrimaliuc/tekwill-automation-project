...
public class AdoptPageActions {
    ...
    public void duplicatedNameCheck(String duplicatedName) {
        ...
        wait.until(ExpectedConditions.textToBePresentInElement(myPageLL.addedPets.get(0), duplicatedName));

        assertThat(myPageLL.addedPets.get(0).getText(), Matchers.equalTo(duplicatedName + "\nAVAILABLE"));
        wait.until(ExpectedConditions.textToBePresentInElement(myPageLL.addedPets.get(1), duplicatedName));
    ...
    public void petIsAdopted(String petName) {
