...
public class UIStepDefinition {
    ...
    Logger log = Logger.getLogger(denis_grimaliuc.UIStepDefinition.class);
    AdoptPage page = null;
    ...
    public void verifyDefaultTextInTheGameSection() {
        ...
        assertThat(page.adoptsInInfo.getText().trim(), Matchers.equalTo("No adoptions. Go get those pets adopted!"));
    }
