...
public class LR_UIStepDefinition {
    ...
    public void openPetstoreLocationChisinau() {
    ...
    public void iValidateTheInfoSection() {
        waitFor(1); // fara aceasta test crush
        var petsCountText = driver.findElement(By.xpath("//div[@data-t='info-section']//p[@data-t ='pets-count']"))
                .getText();
        var adoptionsCountText = driver.findElement(By.xpath("//div[@data-t='info-section']//p[@data-t ='adoptions-count']"))
                .getText();
                assertThat(petsCountText, equalTo("Pets in Chisinau: 12"));
        assertThat(adoptionsCountText, equalTo("Adoptions in Chisinau: 2"));
    }
}
